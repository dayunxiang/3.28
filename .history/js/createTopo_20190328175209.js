    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                ...
                case '亦庄瀛海':
                $text.text('核心层');
                $flowWrap.html('<li><span>至城域网出口流量</span><p></p></li><li><span>至城域网峰值利用率</span><p></p></li><li><span>至骨干网出口流量</span><p></p></li><li><span>至骨干网峰值利用率</span><p></p></li><li><span>至其他核心出口流量</span><p></p></li><li><span>至其他核心峰值利用率</span><p></p></li><li><span>至汇聚层出口流量</span><p></p></li><li><span>至汇聚层峰值利用率</span><p></p></li>');
                break;
            }
        }
    });

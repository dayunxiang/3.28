$(function () {
    ...
    //canvas水球图
    myCanvas = function (cId,cdata,threshold,c_4_num1,c_4_num2) {
        var color,color1;
        switch(cId){
            case 'c1':
            if (cdata >= threshold) {
        ...
        var $ele = $('#'+cId);
        if($ele.attr('id') === 'c_4'){
            $ele.siblings('div').css('height',threshold/12+'px').end().siblings('div').children('span').text(threshold);
        }else{

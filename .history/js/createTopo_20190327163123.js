...
function initCNTopo() {
    ...
    var node_t2_n1 = createNode('CR','lkjf09374832',t2NodeStyle,150,109,177 + 0 * 260, 463,'sub1',null,'');
    var node_t2_n2 = createNode('CR','lkjf09374835',t2NodeStyle,150,109,177 + 1 * 260, 463,'sub1',0,'连接超时');
    var node_t2_n3 = createNode('CR','lkjf09374833',t2NodeStyle,150,109,177 + 2 * 260, 463,'sub1',null,'');
    var node_t2_n4 = createNode('CR','lkjf09374812',t2NodeStyle,150,109,177 + 3 * 260, 463,'sub1',1,'资源不足');

...
function initCNTopo() {
    ...
    //163-->JA
    var edge1_1 = createEdge('','edgei23432r1',edge1Style,node_t1_n1, node_t2_n1,null,'');
    //163-->XD
    var edge1_2 = createEdge('','edgei23432h2',edge1Style,node_t1_n1, node_t2_n2,null,'');
    //163-->DW
    var edge1_3 = createEdge('','edgei2343h1',edge1Style,node_t1_n1, node_t2_n3,null,'');
    //163-->DS
    var edge1_4 = createEdge('','edgei4432h1',edge1Style,node_t1_n1, node_t2_n4,null,'');
    //CN2-->JA
    var edge2_1 = createEdge('','edgei2332r1',edge1Style,node_t1_n2, node_t2_n1,null,'');
    //CN2-->XD
    var edge2_2 = createEdge('','edgei24432h2',edge1Style,node_t1_n2, node_t2_n2,null,'');
    //IDC-->JA
    var edge3_1 = createEdge('','edgei2432r1',edge1Style,node_t1_n3, node_t2_n1,null,'');
    //IDC-->XD
    var edge3_2 = createEdge('','edgeiX432h2',edge1Style,node_t1_n3, node_t2_n2,null,'');
    //IDC-->DW
    var edge3_3 = createEdge('','edgeX343h1',edge1Style,node_t1_n3, node_t2_n3,null,'');
    //IDC-->DS
    var edge3_4 = createEdge('','edgei4X2h1',edge1Style,node_t1_n3, node_t2_n4,null,'');
    //IPTV-->DW
    var edge4_3 = createEdge('','edXei2343h1',edge1Style,node_t1_n4, node_t2_n3,null,'');
    //IPTV-->DS
    var edge4_4 = createEdge('','edXei4432h1',edge1Style,node_t1_n4, node_t2_n4,null,'');
    ...
    var edge4_4_1 = createEdge('','jaToXd',edge2Style,node_t2_n1, node_t2_n2,null,'');
var edge4_4_2 = createEdge('','jaToDw',edge2Style,node_t2_n1, node_t2_n3,null,'');
var edge4_4_3 = createEdge('','jaToDs',edge2Style,node_t2_n1, node_t2_n4,null,'');
var edge4_4_4 = createEdge('','xdToDW',edge2Style,node_t2_n2, node_t2_n3,null,'');
var edge4_4_5 = createEdge('','xdToDs',edge2Style,node_t2_n2, node_t2_n4,null,'');
var edge4_4_6 = createEdge('','dwToDs',edge2Style,node_t2_n3, node_t2_n4,null,'');

edge4_4_1.s({'edge.source.offset.y': 15,'edge.target.offset.y': 15,'edge.ripple.elevation': 50/3});
edge4_4_2.s({'edge.source.offset.y': 30,'edge.target.offset.y': 30,'edge.ripple.elevation': 200/3});
edge4_4_3.s({'edge.source.offset.y': 45,'edge.target.offset.y': 45,'edge.ripple.elevation': 450/3});
edge4_4_4.s({'edge.source.offset.y': 15,'edge.target.offset.y': 15,'edge.ripple.elevation': 50/3});
edge4_4_5.s({'edge.source.offset.y': 30,'edge.target.offset.y': 30,'edge.ripple.elevation': 200/3});
edge4_4_6.s({'edge.source.offset.y': 15,'edge.target.offset.y': 15,'edge.ripple.elevation': 50/3});

var edge5_1 = createEdge('','',edge3Style,node_t2_n1, node_t3_n1,null,'');
var edge5_2 = createEdge('','',edge3Style,node_t2_n2, node_t3_n2,null,'');
var edge5_3 = createEdge('','',edge3Style,node_t2_n3, node_t3_n3,null,'');
var edge5_4 = createEdge('','',edge3Style,node_t2_n4, node_t3_n4,null,'');
    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                ...
                case 'IPTV':
                $text.text('骨干层');
                $flowWrap.html('<li><span>至静安出口流量</span><p id="crJa"></p></li><li><span>至静安峰值利用率</span><p id="crJas"></p></li><li><span>至西单出口流量</span><p id="crXd"></p></li><li><span>至西单峰值利用率</span><p id="crXds"></p></li><li><span>至德外出口流量</span><p id="crDw"></p></li><li><span>至德外峰值利用率</span><p id="crDws"></p></li><li><span>至东四出口流量</span><p id="crDs"></p></li><li><span>至东四峰值利用率</span><p id="crDss"></p></li><li><span>各核心至IPTV总出口流量</span><p id="toIptv"></p></li><li><span>各核心至IPTV总峰值利用率</span><p id="toIptvs"></p></li>');
                break;
                case '静安':
                $text.text('核心层');
...
function initIDCTopo() {
    ...
    idcEdge3['edge3_101'] = createEdge('酒仙桥-->东四核心','',edge3Style,node_t3_n3, node_t2_n1,null,'');
    idcEdge3['edge3_102'] = createEdge('酒仙桥-->永丰核心','',edge3Style,node_t3_n3, node_t2_n3,null,'');
    ...
    idcEdge3['edge3_121'] = createEdge('润泽-->亦庄瀛海核心','',edge3Style,node_t3_n9, node_t2_n2,null,'');
    idcEdge3['edge3_122'] = createEdge('润泽-->永丰核心','',edge3Style,node_t3_n9, node_t2_n1,null,'');
    ...
    idcEdge3['edge3_32'] = createEdge('瀛海-->永丰核心','',edge3Style,node_t3_n17, node_t2_n1,null,'');
    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                case '北京电信城域网':
                $text.text('骨干层');
                $flowWrap.html('<li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li><li><span>各核心至城域网总出口流量</span><p id="cywToHx"></p></li><li><span>各核心至城域网总峰值利用率</span><p id="cywToHxs"></p></li>');
                break;
                case '中国电信IP骨干网':
                $text.text('骨干层');
                $flowWrap.html('<li><span>至亦庄瀛海出口流量</span><p id="toHxYz"></p></li><li><span>至亦庄瀛海峰值利用率</span><p id="toHxYzs"></p></li><li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li><li><span>各核心至骨干网总出口流量</span><p id="cywToHx"></p></li><li><span>各核心至骨干网总峰值利用率</span><p id="cywToHxs"></p></li>');
                break;
                case '亦庄瀛海':
                $text.text('核心层');
                $flowWrap.html('<li><span>至城域网出口流量</span><p id="toCyw"></p></li><li><span>至城域网峰值利用率</span><p id="toCyws"></p></li><li><span>至骨干网出口流量</span><p id="toGg"></p></li><li><span>至骨干网峰值利用率</span><p id="toGgs"></p></li><li><span>至其他核心出口流量</span><p id="hxToHx"></p></li><li><span>至其他核心峰值利用率</span><p id="hxToHx"></p></li><li><span>至汇聚层出口流量</span><p id="hxToHj"></p></li><li><span>至汇聚层峰值利用率</span><p id="hxToHjs"></p></li>');
                break;
                case '东四':
                $text.text('核心层');
                $flowWrap.html('<li><span>至城域网出口流量</span><p id="toCyw"></p></li><li><span>至城域网峰值利用率</span><p id="toCyws"></p></li><li><span>至骨干网出口流量</span><p id="toGg"></p></li><li><span>至骨干网峰值利用率</span><p id="toGgs"></p></li><li><span>至其他核心出口流量</span><p id="hxToHx"></p></li><li><span>至其他核心峰值利用率</span><p id="hxToHx"></p></li><li><span>至汇聚层出口流量</span><p id="hxToHj"></p></li><li><span>至汇聚层峰值利用率</span><p id="hxToHjs"></p></li>');
                ...
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li>');
                break;
                case '望京嘉轩':
                $text.text('汇聚层');
                $flowName.text('IDC');
                ...
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li>');
                break;
                case '静安':
                $text.text('汇聚层');
                $flowName.text('IDC');
                ...
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li>');
                break;
                case '亦庄':
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至亦庄瀛海出口流量</span><p id="toHxYz"></p></li><li><span>至亦庄瀛海峰值利用率</span><p id="toHxYzs"></p></li><li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li>');
                break;
                case '润泽':
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至亦庄瀛海出口流量</span><p id="toHxYz"></p></li><li><span>至亦庄瀛海峰值利用率</span><p id="toHxYzs"></p></li><li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li><li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li>');
                break;
                case '北七家':
                $text.text('汇聚层');
                $flowName.text('IDC');
                ...
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li>');
                break;
                case '兆维':
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li>');
                break;
                case '东四':
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至东四出口流量</span><p id="toHxDs"></p></li><li><span>至东四峰值利用率</span><p id="toHxDss"></p></li>');
                break;
                case '中广亚':
                $text.text('汇聚层');
                $flowName.text('IDC');
                ...
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至亦庄瀛海出口流量</span><p id="toHxYz"></p></li><li><span>至亦庄瀛海峰值利用率</span><p id="toHxYzs"></p></li><li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li>');
                break;
                case '中兴':
                $text.text('汇聚层');
                $flowName.text('IDC');
                ...
                $text.text('汇聚层');
                $flowName.text('IDC');
                $flowWrap.html('<li><span>至永丰出口流量</span><p id="toHxYf"></p></li><li><span>至永丰峰值利用率</span><p id="toHxYfs"></p></li><li><span>至兆维出口流量</span><p id="toHxZw"></p></li><li><span>至兆维峰值利用率</span><p id="toHxZws"></p></li>');
                break;
            }
        }
    });
...
/* add 3.28 */
function warnNode(id, status, tip) {
  var warnNote = dm.getDataById(id);
  warnNote.status = status;
  warnNote.toolTip = tip;

  if (warnNote.nodeType == "node") {
    if (status == 0) {
      warnNote.setAnimation(animWarn0);
    } else if (status == 1) {
      warnNote.setAnimation(animWarn1);
    } else {
      warnNote.setAnimation(null);
    }
  } else if (warnNote.nodeType == "edge") {
    if (status == 0) {
      warnNote.s({ "edge.color": "#f08619" });
    } else if (status == 1) {
      warnNote.s({ "edge.color": "#da281c" });
    } else {
      warnNote.s({ "edge.color": "#25a139" });
    }
  }
}
/* 3.28add end */

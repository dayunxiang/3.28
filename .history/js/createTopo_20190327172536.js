...
function initCNTopo() {
    ...
    var node_t2_n3 = createNode('兆维','lkjf09374833',t2NodeStyle,150,109,177 + 2 * 260, 463,'sub1',null,'');
    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                ...
                $text_sub.text('163');
                $flowName.text('163');
                $flowWrap.html('<li><span>至静安出口流量</span><p id="crJa"></p></li><li><span>至静安峰值利用率</span><p id="crJas"></p></li>');
            }
            $('#con_idc').show();
        }
    });

$(function () {
    ...
    function numAnimation(){
        ...
        new CountUp("num_zq_4", 30, 30, 0, 3, options).start();
        ...
        new CountUp("num_yd_4", 50, 60, 0, 3, options).start();
        ...
        new CountUp("num_kd_4", 120, 130, 0, 3, options).start();
        ...
        new CountUp("num_wl_4", 70, 90, 0, 3, options).start();
    };

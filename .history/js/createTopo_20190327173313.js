    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                ...
                $text_sub.text('163');
                $flowName.text('163');
                $flowWrap.html('<li><span>至静安出口流量</span><p id="crJa"></p></li><li><span>至静安峰值利用率</span><p id="crJas"></p></li><li><span>至西单出口流量</span><p id="crXd"></p></li><li><span>至西单峰值利用率</span><p id="crXds"></p></li><li><span>至德外出口流量</span><p id="crDw"></p></li><li><span>至德外峰值利用率</span><p id="crDws"></p></li><li><span>至东四出口流量</span><p id="crDs"></p></li><li><span>至东四峰值利用率</span><p id="crDss"></p></li><li><span>至静安出口流量</span><p id="crJa"></p></li><li><span>至静安峰值利用率</span><p id="crJas"></p></li>');
            }
            $('#con_idc').show();
        }
    });

    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                ...
                case '静安':
                $text.text('核心层');
                $flowWrap.html('<li><span>至163出口流量</span><p id="to163"></p></li><li><span>至163峰值利用率</span><p id="to163s"></p></li><li><span>至CN2出口流量</span><p id="toCn"></p></li><li><span>至CN2峰值利用率</span><p id="toCns"></p></li><li><span>至IDC出口流量</span><p id="toIdc"></p></li><li><span>至IDC峰值利用率</span><p id="toIdcs"></p></li><li><span>至东四出口流量</span><p id="crDs"></p></li><li><span>至东四峰值利用率</span><p id="crDss"></p></li><li><span>各核心至163总出口流量</span><p id="to163"></p></li><li><span>各核心至163总峰值利用率</span><p id="to163s">100%</p></li>');
                break;
            }
            $('#con_idc').show();
        }

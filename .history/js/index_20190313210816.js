$(function () {
    ...
    //工单总计求和
    function sum($id){
        var idStr = $id.attr('id');
        var tempIdStr = idStr.substring(0,idStr.length-1);
        var num1 = $('#'+tempIdStr+'1').text();
        var num2 = $('#'+tempIdStr+'2').text();
        var num3 = $('#'+tempIdStr+'3').text();
        $id.text(parseInt(num1)+parseInt(num2)+parseInt(num3));
    }
    sum($('#num_zq_4'));
    sum($('#num_yd_4'));
    sum($('#num_kd_4'));

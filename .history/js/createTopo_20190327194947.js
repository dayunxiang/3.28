...
function initCNTopo() {
    ...
    //三级连线
    var edge1Style={'edge.width': 1,'edge.gap': 10,'edge.dash': false,'edge.offset': 50,'edge.toggleable': false,'edge.color': '#fff'}
    ...
    view.addEventListener("click", function(e){
        ...
        if(data){
            ...
            switch(nodeName){
                ...
                case 'IPTV':
                $text.text('骨干层');
                $flowWrap.html('<li><span>至静安出口流量</span><p id="crJa"></p></li><li><span>至静安峰值利用率</span><p id="crJas"></p></li><li><span>至西单出口流量</span><p id="crXd"></p></li><li><span>至西单峰值利用率</span><p id="crXds"></p></li><li><span>至德外出口流量</span><p id="crDw"></p></li><li><span>至德外峰值利用率</span><p id="crDws"></p></li><li><span>至东四出口流量</span><p id="crDs"></p></li><li><span>至东四峰值利用率</span><p id="crDss"></p></li><li><span>各核心至IPTV总出口流量</span><p id="toIptv"></p></li><li><span>各核心至IPTV总峰值利用率</span><p id="toIptvs">100%</p></li>');
                break;
                case '静安':
                $text.text('核心层');
